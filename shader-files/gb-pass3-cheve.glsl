...
uniform COMPAT_PRECISION float shadow_blur2;
#else
#define shadow_blur2 2.0
#endif
...
// I kept the old path when available for readability and speed(?)
    ...
    */	
    ...
    float weights3 = 0.13 - (shadow_blur2 / 100.0); //0.11883557904592230273554609080014;
    float weights4 = 0.13 - (3.0 * shadow_blur2 / 100.0); //0.10164546793794160274995705611009;
    ...
    */
    float weights[5] = float[]( 0.13, //0.13465834124289953661305802732548,       
                                ...
                                0.13 - (shadow_blur2 / 100.0), //0.11883557904592230273554609080014,         
                                0.13 - (3.0 * shadow_blur2 / 100.0), //0.10164546793794160274995705611009,      
